...
<!--Judul-->
    <main class="ms-sm-auto"><br>
      ...
      <div class="col">
      <h2><b>Cara Melihat Laporan</b></h2>
      <p class="text-secondary">Apa yang bisa kami bantu?</p>
      </div></div>

      <div class="tabcontent">
        <p><span class="circle">1</span>Pergi ke “Laporan”.</p>
        <img src="https://assets-cdn.shipper.id/bos-web/v1.18.1-alpha2/assets/images/image-help-report-1.png" class="gambar"> 
        <p><span class="circle">2</span>Pilih mulai tanggal dan sampai tanggal untuk memilih rentang laporan.</p>
        <img src="https://assets-cdn.shipper.id/bos-web/v1.18.1-alpha2/assets/images/image-help-report-2.png" class="gambar">
        <p><span class="circle">3</span>Klik tombol “Lihat Laporan”.</p>
        <img src="https://assets-cdn.shipper.id/bos-web/v1.18.1-alpha2/assets/images/image-help-report-3.png" class="gambar">
        <p><span class="circle">4</span>Klik tombol “Download” jika ingin “men-download laporan.</p>
        <img src="https://assets-cdn.shipper.id/bos-web/v1.18.1-alpha2/assets/images/image-help-report-4.png" class="gambar">
      </div>
