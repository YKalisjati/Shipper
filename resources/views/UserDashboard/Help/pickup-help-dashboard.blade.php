...
<html lang="en">
  <head>
    ...
    <title>Help | Create Pickup</title>

<link href="	https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet">
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet">
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js"></script>
<link href="/css/dashboard.css" rel="stylesheet">
<link href="/css/help-pickup.css" rel="stylesheet">
...
<!--Judul-->
    <main class="ms-sm-auto"><br>
      ...
      <div class="col">
      <h2><b>Cara Ajukan Penjemputan</b></h2>
      <p class="text-secondary">Apa yang bisa kami bantu?</p>
      </div></div>

      <div class="tabcontent">
        <p><span class="circle">1</span>Pergi ke “Ajukan Penjemputan”. Kemudian, pilih alamat penjemputan.</p>
        <img src="https://assets-cdn.shipper.id/bos-web/v1.18.1-alpha2/assets/images/image-help-create-pickup-1.png" class="gambar"> 
        <p><span class="circle">2</span>Pilih tipe pesanan.</p>
        <img src="https://assets-cdn.shipper.id/bos-web/v1.18.1-alpha2/assets/images/image-help-create-pickup-2.png" class="gambar">
        <p><span class="circle">3</span>Centang pesanan yang ingin dijemput</p>
        <img src="https://assets-cdn.shipper.id/bos-web/v1.18.1-alpha2/assets/images/image-help-create-pickup-3.png" class="gambar">
        <p><span class="circle">4</span>Klik tombol “Pilih Jadwal Penjemputan” di pojok kanan bawah.</p>
        <img src="https://assets-cdn.shipper.id/bos-web/v1.18.1-alpha2/assets/images/image-help-create-pickup-4.png" class="gambar">
        <p><span class="circle">5</span>Pilih jadwal pickup. Setelah itu, klik tombol “Pilih Jadwal Pickup”.</p>
        <img src="https://assets-cdn.shipper.id/bos-web/v1.18.1-alpha2/assets/images/image-help-create-pickup-5.png" class="gambar">
      </div>
