...
<html lang="en">
  <head>
    ...
    <title>Bulk Upload Cashless</title>
      ...
      <div class="row border-bottom">
        ...
        <div class="col">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">
              <h1 class="mt-2"><b>Bulk Upload Cashless</b> <p class="h6 text-secondary mt-2">Unggahan Pesanan Masal</p> </h1>
          </div>
        </div>
        ...
        <div id="order2" class="tabcontent"><br>
          <div class="card card-body" style="border-radius:8px">
            ...
            <div class="align-items-center text-center"><br>
              <a href="{{route('downloadTemplateDomestik')}}" style="text-decoration: none;"><button type="button" class="form-control">Download Template</button></a>
            </div>
          </div><br>
          ...
          <div class="card card-body align-items-center" style="border-radius:8px">
            ...
            <div class="card card-body">
              <p class="ket-upload">Geser file .xlsx Anda di sini<br>atau</p>
              <div class="row pilihFile ">
                <button type="button" class="btn btn-dangerTest" name="pilih" id="piliFile">Pilih File</button>
              </div>
            </div> 
