          ...
          <div style="min-width:600px;" class="col-sm-6 container" >
            <div class="login-wrapper my-auto mx-auto ">
              ...
              @if(Session::has('success'))
                ...
                @endif
                <h1 class="login-title bg-white rounded border border-danger p-2"><b class="text-danger">Masuk ke dalam akun Anda</b></h1>
              <div  class="login-title text-right">
              <p style="font-size:14px;" class="text-secondary">Belum punya akun? <a class="text-reset"><a href="/register" class="daftar-sekarang-link"><u>Daftar Sekarang</u></a></p>
              </div>
              <form action="{{route('login-user')}}" method="post">
                ...
                <div>
                <div  class="login-title text-right">
                <p style="font-size:14px;" class="text-secondary">Lupa Password? <a class="text-reset"><a href="/lupa-sandi" class="daftar-sekarang-link"><u>Klik disini</u></a></p>
                </div>
                <input name="login" id="login" href="#g-plus" class="btn btn-block login-btn btn-danger" type="submit" value="Masuk">
                </div>
              </form>
                <div  class="login-title text-left">
                  <p style="font-size:14px;" class="text-secondary">Jika Anda belum memiliki akun (mendaftar), silahkan untuk mendaftarkan diri terlebih dahulu, dengan masuk ke halaman register atau menekan tombol <i>Daftar Sekarang</i>.
                    Jika anda lupa password, silahkan menekan tombol <i>Klik disini</i></p>
                  </div>
            </div>
