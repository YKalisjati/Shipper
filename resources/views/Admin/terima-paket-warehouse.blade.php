  ...
  <div id="modalJemput" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            ...
            <div id="bodyModalJemput" class="modal-body ">
                ...
                <form action="{{route('WarehouseTerimaPaket')}}" method="post" id="postJemputPesanan">
                @csrf
    ...
    @include('partials.adminHamburgerMenu')
        <div class="col">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">
            <h1 class="mt-2"><b>Warehouse Paket</b><p class="h6 text-secondary mt-2"> {{ count($dataPenjemputan) }} Pesanan Belum Sampai di Warehouse</p> </h1>
            <div class="dropdown">
              <p>Hello,
...
<!--MAIN-->
    ...
    @if(count($dataPenjemputan)!=0)
      <div id="dataPenjemputan" class="tabcontent" >
        <div class="container">
        <h4 class="text-white bg-danger p-2">Silahkan pilih pesanan yang telah sampai di warehouse</h4>
    ...
    function jemputPesanan(){
     ...
     function jemputButtonListener(){
        ...
        if(allChecked.length!=0){
          ...
          var msg = $("#messageJemput").text("Apakah anda yakin pesanan berikut ini telah sampai di warehouse") ;
