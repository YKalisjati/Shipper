  ...
  <div id="modalJemput" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            ...
            <div id="bodyModalJemput" class="modal-body ">
                ...
                <form action="{{route('jemputPesanan')}}" method="post" id="postJemputPesanan">
                @csrf
    ...
    @include('partials.adminHamburgerMenu')
        <div class="col">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">
            <h1 class="mt-2"><b>Jemput Pesanan</b><p class="h6 text-secondary mt-2"> {{ count($dataPenjemputan) }} Pesanan Butuh Penjemputan</p> </h1>
            <div class="dropdown">
              <p>Hello,
...
<!--MAIN-->
    ...
    @if(count($dataPenjemputan)!=0)
      <div id="dataPenjemputan" class="tabcontent" >
        <div class="container">
        <h4 class="text-white bg-danger p-2">Silahkan pilih pesanan yang akan di jemput</h4>
        ...
        <div class="container d-flex flex-row-reverse">
          <div class="mt-3">
            <button type="button" class="btn tabBtn btn-danger" onclick="jemputButtonListener()";>Jemput Pesanan</button>
          </div>
        </div>
      </div>
      @else
        <p style="text-align: center;">Tidak ada pesanan yang dapat di Jemput</p>
      @endif
    </main>   
  </div>
  ...
  <script>
    ...
    function jemputPesanan(){
      ...
      if(allChecked.length!=0){
        ...
        $("#message").text("Silahkan memilih data yang akan dijemput terlebih dahulu.") ;
     ...
     function jemputButtonListener(){
        ...
        var msg = $("#messageJemput").text("Apakah anda yakin ingin menjemput pesanan berikut ini") ;
    ...
    function checkBoxListener(){
      ...
      for (var i = 0; i < allChecked.length; i++) {
        if(date>=allChecked[i].value){
          ...
          $("#modalNotifikasi").modal('show');
          $("#judul-modal").text("Warning!") ;
          $("#message").text("Pesanan dengan Id : "+allChecked[i].id+" dapat dijemput mulai tanggal "+allChecked[i].value)+"." ;
